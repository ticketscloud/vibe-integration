...
export type Event = {
	...
	// Статус мероприятия
	// active - мероприятие активно и доступно для покупок
	// paused - мероприятие приостановлено и не доступно для покупок
	// finished - мероприятие завершено и не доступно для покупок
	// cancelled - мероприятие отменено и не доступно для покупок
